...
- timelimit
- ignore case
- [unofficial patch](https://github.com/itefixnet/cwrsync-client/build/no-password-file-check.diff) to avoid permissions error for password file option
...
* Use the provided **[cwrsync.cmd](https://github.com/itefixnet/cwrsync-client/build/cwrsync.cmd)** for proper use or guidance
